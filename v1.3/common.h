...
typedef struct{
    ...
    int id_atleta_serv;     //PID o ID dell'atleta attualmente servito
    int servizio_corrente;  //Quale servizio sta erogando (0-5)
    int tkt_corrente;       //Num.ticket dell'atleta in servizio
}StatoPostazione;
...
typedef struct{
    ...
    int terminato;              //vale 1 se la sim è finita
    int coda_erogatore;         //Num di atleti in attesa di ticket 
    StatoPostazione postazioni[20]; //Max 20 postazioni/sportelli
